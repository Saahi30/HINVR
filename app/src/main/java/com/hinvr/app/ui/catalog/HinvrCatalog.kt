...
object HinvrCatalog {
    ...
    val bundledMandirs = listOf(
        ...
        Mandir(
            ...
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/VishwanathThumbnail.jpg",
            liveUrl = "https://www.youtube.com/watch?v=J0nRdUOQps8",
        ),
        Mandir(
            id = "shirdi",
            name = "Sai Baba",
            ...
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1661929612732_saibaba.jpeg",
            liveUrl = "https://www.youtube.com/watch?v=6Uf3aMujHa8",
        ),
        Mandir(
            id = "kedarnath",
            name = "Kedarnath",
        ...
        Mandir(
            ...
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1705928484187_Somnath-Temple-Photo.jpg",
            liveUrl = "https://www.youtube.com/watch?v=J4z7CIrvsuw",
        ),
        Mandir(
            id = "vaishno-devi",
            name = "Vaishno Devi",
        ...
        Mandir(
            ...
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1765787601725_JagnathJi360_420.png",
            liveUrl = "https://www.youtube.com/watch?v=oX0HEkwdWqo",
        ),
        Mandir(
            id = "dwarkadhish",
            name = "Dwarkadhish",
            ...
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/dwarkadhish-shringar-darshan.jpg",
            liveUrl = "https://www.youtube.com/watch?v=E7tDjVkkHJ4",
        ),
        Mandir(
            id = "badrinath",
            name = "Badrinath",
        ...
        Mandir(
            ...
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1661936121433_siddhivinayak.jpeg",
            liveUrl = "https://www.youtube.com/watch?v=1vGVGya72bQ",
        ),
        Mandir(
            id = "iskcon-bengaluru",
        ...
        Mandir(
            ...
            live = true,
            passAccepted = true,
            timings = "Bhasma aarti before dawn · Darshan through the day",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1739895956583_mahakal_bg.jpg",
            liveUrl = "https://www.youtube.com/watch?v=vOIx1wXmc7I",
        ),
        Mandir(
            id = "mahalakshmi",
            name = "Mahalakshmi",
            ...
            scene = TileScene.Tirupati,
            live = true,
            timings = "Morning and evening aarti · Darshan through the day",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/mahalaxmi-mumbai.png",
            liveUrl = "https://www.youtube.com/watch?v=DHRoHpI_rcI",
        ),
        Mandir(
            id = "jagannath-ahmedabad",
            name = "Jagannathji",
            ...
            live = true,
            nextAarti = "6:00 PM",
            timings = "Morning and evening aarti · Rath Yatra in Ashadha",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1783929583797_JagannathRathYatra.png",
            liveUrl = "https://www.youtube.com/watch?v=2qsfeM6lInw",
        ),
        Mandir(
            id = "mohankheda",
            name = "Mohankheda",
            ...
            scene = TileScene.Kedarnath,
            live = true,
            timings = "Daily darshan · Jain pilgrimage site",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1723659948051_mohankheda.png",
            liveUrl = "https://www.youtube.com/watch?v=mKJ9J7J7tUM",
        ),
        Mandir(
            id = "ashapura-mata",
            name = "Ashapura Mata",
            ...
            scene = TileScene.Kedarnath,
            live = true,
            timings = "Morning and evening aarti",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1723659373125_ashapuramata.jpeg",
            liveUrl = "https://www.youtube.com/watch?v=SEQ3p6hELo8",
        ),
        Mandir(
            id = "sarangpur",
            name = "Kashtbhanjan Dev",
            place = "Sarangpur, Gujarat",
            city = "Sarangpur",
            scene = TileScene.Shirdi,
            live = true,
            timings = "Hanuman darshan through the day · Aarti morning and evening",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/salangpurThumbnail.jpeg",
            liveUrl = "https://www.youtube.com/watch?v=KomUNKwJu6c",
        ),
        Mandir(
            id = "vadtal",
            name = "Laxminarayan Dev",
            place = "Vadtal, Gujarat",
            city = "Vadtal",
            scene = TileScene.Tirupati,
            live = true,
            timings = "Mangala aarti at dawn · Shringar and evening aarti",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1780044517234_vadtaldham.png",
            liveUrl = "https://www.youtube.com/watch?v=IIuk2Y9dqHc",
        ),
        Mandir(
            id = "khatu-shyam",
            name = "Khatu Shyam",
            place = "Khatu, Rajasthan",
            city = "Sikar",
            scene = TileScene.Kashi,
            live = true,
            passAccepted = true,
            timings = "Mangala aarti at dawn · Darshan through the evening",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1780047009461_khatushyamji.png",
            liveUrl = "https://www.youtube.com/watch?v=dke2IQtIfUM",
        ),
        Mandir(
            id = "narnarayan-bhuj",
            name = "NarNarayan Dev Bhuj",
            place = "Bhuj, Kutch",
            city = "Bhuj",
            scene = TileScene.Tirupati,
            live = true,
            timings = "Mangala aarti · Shringar darshan · Evening aarti",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1780048186962_ShreeSwaminarayanMandir-Bhuj.png",
            liveUrl = "https://www.youtube.com/watch?v=oJ8nu5DDRoc",
        ),
        Mandir(
            id = "narnarayan-kalupur",
            name = "NarNarayan Dev Kalupur",
            place = "Kalupur, Ahmedabad",
            city = "Kalupur",
            scene = TileScene.Tirupati,
            live = true,
            timings = "Mangala aarti · Shringar darshan · Evening aarti",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1780050208861_KalupurSwaminarayanMandir.png",
            liveUrl = "https://www.youtube.com/watch?v=5ppU7BqHdvs",
        ),
        Mandir(
            id = "gopinathji-gadhada",
            name = "Gopinathji",
            place = "Gadhada, Gujarat",
            city = "Gadhada",
            scene = TileScene.Tirupati,
            live = true,
            timings = "Daily aarti and shringar darshan at Gadhpur Dham",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1780050959554_GadhpurDham.png",
            liveUrl = "https://www.youtube.com/watch?v=xWi4BUuDb7k",
        ),
        Mandir(
            id = "ranchhodraiji-dakor",
            name = "Ranchhodraiji",
            place = "Dakor, Gujarat",
            city = "Dakor",
            scene = TileScene.Somnath,
            live = true,
            timings = "Mangala aarti · Shringar darshan · Evening aarti",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1780051497234_ShriRanchhodraiji.png",
            liveUrl = "https://www.youtube.com/watch?v=sylr5qU9uoU",
        ),
        Mandir(
            id = "radha-govinda-hyderabad",
            name = "Radha-Govinda",
            place = "Banjara Hills, Hyderabad",
            city = "Hyderabad",
            scene = TileScene.Tirupati,
            live = true,
            timings = "Mangala aarti at dawn · Kirtan and evening aarti",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1780052590256_HareKrishnaGoldenTemple.png",
            liveUrl = "https://www.youtube.com/watch?v=TP7KeclRHcc",
        ),
        Mandir(
            id = "ram-lalla",
            name = "Ram Lalla",
            ...
            passAccepted = true,
            timings = "Mangala aarti at dawn · Shringar and evening aarti",
            photoUrl = "https://storage.googleapis.com/livebhagwan-7dd31.appspot.com/1780053121561_ramlalla.png",
            liveUrl = "https://www.youtube.com/watch?v=xThGBtk3E_A",
        ),
...
private fun withBundledInformation(mandir: Mandir): Mandir = when (mandir.id) {
    ...
    "mahakal" -> mandir.copy(
        deity = "Lord Mahakal",
        summary = "A jyotirlinga in Ujjain, known for the pre-dawn Bhasma aarti and a living Shaiva city around the shrine.",
        history = "Mahakaleshwar stands in Ujjain, one of India’s seven moksha puris. The present complex has been rebuilt across centuries, with the lingam worshipped as dakshinamurti — south-facing.",
        significance = "One of the twelve jyotirlingas. Pilgrims come for Bhasma aarti, the Sawari procession, and the sacred Shipra.",
        architecture = "A multi-storey stone complex with the garbhagriha below courtyard level, later shikharas, and a large sabha around the lingam.",
        dressCode = "Traditional or modest clothing. Bhasma aarti has a stricter dress and booking rule.",
        bestTime = "Weekday Bhasma aarti with an official booking, or early morning darshan outside festivals.",
        visitorNotes = "Use official temple channels for Bhasma aarti. Crowds are intense on Mondays and during Savan.",
        facilities = "Official aarti booking\nLockers\nPrasad counters\nWheelchair assistance on selected routes",
        address = "Mahakaleshwar Temple Road, Ujjain, Madhya Pradesh 456006",
        officialWebsite = "https://shreemahakaleshwar.com/",
    )
    "ram-lalla" -> mandir.copy(
        deity = "Ram Lalla",
        summary = "The Janmabhoomi shrine in Ayodhya, built around the childhood form of Sri Rama.",
        history = "The present stone temple was consecrated in 2024 on the site long associated with Rama’s birth, after a long legal and public history.",
        significance = "Ayodhya is Rama’s city. Darshan of Ram Lalla is paired with Saryu snan and visits to nearby Hanuman Garhi and Kanak Bhawan.",
        architecture = "A Nagara temple in pink sandstone, with mandapas, carved pillars, and a rising shikhara over the garbhagriha.",
        dressCode = "Modest clothing. Follow current security, locker, and electronics rules at the gates.",
        bestTime = "Early weekday mornings outside major festival days.",
        visitorNotes = "Carry accepted photo ID. Queue and corridor rules change; follow the current notice at the dham.",
        facilities = "Official entry corridors\nLockers\nDrinking water\nPrasad counters\nWheelchair assistance",
        address = "Ram Janmabhoomi, Ayodhya, Uttar Pradesh 224123",
        officialWebsite = "https://srjbtkshetra.org/",
    )
    "khatu-shyam" -> mandir.copy(
        deity = "Khatu Shyam",
        summary = "The shrine of Barbarika at Khatu in Sikar district, worshipped as Shyam, a form of Krishna’s grace.",
        history = "Tradition holds that Krishna blessed Barbarika to be worshipped in Kali Yuga as Shyam. The present temple at Khatu is the principal seat of that devotion.",
        significance = "Devotees come for Phalgun mela, daily aarti, and the cry of ‘Hare ka Sahara, Baba Shyam hamara’.",
        architecture = "A marble and lime-washed Rajasthani shrine with a silver-doored sanctum and crowded parikrama lanes.",
        dressCode = "Clean, modest clothing. Cover shoulders and knees in the inner sabha.",
        bestTime = "Weekdays outside the Phalgun fair, arriving before evening aarti.",
        visitorNotes = "The town fills quickly on weekends and ekadashi. Use official notices for darshan and offering rules.",
        facilities = "Prasad counters\nLockers\nDrinking water\nCrowd management on festival days",
        address = "Khatu Shyam Mandir, Khatu, Sikar, Rajasthan 332602",
    )
    else -> mandir.copy(
        deity = when (mandir.id) {
            ...
            "jagannath-ahmedabad" -> "Lord Jagannath"
            "mohankheda" -> "Acharya Rajendra Suri"
            "ashapura-mata" -> "Ashapura Mata"
            "sarangpur" -> "Kashtbhanjan Hanuman"
            "vadtal" -> "Laxminarayan Dev"
            "narnarayan-bhuj" -> "NarNarayan Dev"
            "narnarayan-kalupur" -> "NarNarayan Dev"
            "gopinathji-gadhada" -> "Gopinathji Maharaj"
            "ranchhodraiji-dakor" -> "Ranchhodraiji"
            "radha-govinda-hyderabad" -> "Radha-Govinda"
            else -> ""
        },
